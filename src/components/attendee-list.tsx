      ...
      <Table>
        <thead>
          <tr className="border-b border-white/10">
            <TableHeader style={{ width: 48 }}>
              <input type="checkbox" className="size-3 bg-black/20 rounded border border-white/10 text-orange-400 focus:ring-0 focus:ring-offset-0" />
            </TableHeader>
        ...
        <tbody>
          {attendees.slice((page - 1) * 10, page * 10).map((attendee) => {
            return (
              <TableRow key={attendee.id}><TableCell>
                <input type="checkbox" className="size-3 bg-black/20 rounded border border-white/10 text-orange-400 focus:ring-0 focus:ring-offset-0" />
              </TableCell>
        ...
        <tfoot>
          <tr>
            <TableCell colSpan={3}>
              Mostrando 10 de 228 itens {attendees.length}
            </TableCell>
            <td className="py-3 px-4 text-sm text-zinc-300 text-right" colSpan={3}>
              <div className="inline-flex items-center gap-8">
                ...
                <div className="flex gap-1.5">
                  <IconButton onClick={goToStartPage} disabled={page === 1}>
